class Apis {
  final String loginurl = 'https://simple-blogging.onrender.com/users/login';
  final String baseurl = 'https://simple-blogging.onrender.com';
  final String authurl = '/users/login';
