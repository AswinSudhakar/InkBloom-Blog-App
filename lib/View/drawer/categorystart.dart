...
class CategoryScreenstart extends StatefulWidget {
  const CategoryScreenstart({super.key});

  @override
  State<CategoryScreenstart> createState() => _CategoryScreenState();
}

class _CategoryScreenState extends State<CategoryScreenstart> {
